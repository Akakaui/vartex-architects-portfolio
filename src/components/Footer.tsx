            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
                ...
                <div className="lg:col-span-2 lg:col-start-5 flex flex-col gap-4 lg:gap-8">
                    ...
                    <nav className="flex flex-wrap gap-4 lg:gap-5 items-center">
                        ...
                        {/* Behance */}
                        <a href="https://www.behance.net/vartex_architects" target="_blank" rel="noopener noreferrer" aria-label="Behance" className="hover:opacity-40 transition-opacity text-primary dark:text-white">
                        ...
                        {/* YouTube */}
                        <a href="https://www.youtube.com/@vartex_architects" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="hover:opacity-40 transition-opacity text-primary dark:text-white">
